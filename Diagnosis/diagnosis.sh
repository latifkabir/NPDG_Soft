...
file1=/home/daq/NPDGamma/Diagnosis/CurrentConfig
file2=/home/daq/NPDGamma/Diagnosis/ExpectedClean
file3=/home/daq/NPDGamma/Diagnosis/ExpectedDirty
file4=/home/daq/NPDGamma/Diagnosis/power_reset
...
CheckConfig()
{
    ...
    GetConfig $1 > /home/daq/NPDGamma/Diagnosis/CurrentConfig
    TIMED_OUT=$?
...
ResetPower()
{
    if [ ${LIVE[0]} == 0 ]
    then
	/home/daq/NPDGamma/Diagnosis/power_reset 21
    fi

    if [ ${LIVE[4]} == 0 ]
    then
	/home/daq/NPDGamma/Diagnosis/power_reset 30
    fi
...
then
	...
	then
	    ...
	    /home/daq/NPDGamma/Watchdog/bin/textAlert.sh "Fixed the issue. Initiated automated n3He data taking process"
	    /home/daq/NPDGamma/NPDG_DAQ/bin/npdg auto
	fi
    else
