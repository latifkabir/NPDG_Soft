/*
GUI for reading & displaying magnetic field from flux gate(A magnetometer from Bartington, Model:Mag-03DAM) on Ncurses window
...
int main(void) 
{
    ...
    mvprintw(3, 30, "Welcome to NPDG Field Monitoring GUI Program ");
...
//-----------------------------Header of the Program---------------------
		    mvprintw(2, 25, "----------------------------------------------- ");
		    mvprintw(3, 30, "NPDG Magnetic Field  monitoring Program ");
...
//-------------------------Parameters List------------------------------
		    ...
		    mvprintw(12, 10, "Field X1: %lf Gauss", field[0]);
		    mvprintw(13, 10, "Field Y1: %lf Gauss", field[1]);
		    mvprintw(14, 10, "Field Z1: %lf Gauss", field[2]);
		    mvprintw(16, 30, "Max Range : %lf Gauss", field[6]);
		    mvprintw(17, 30, "Offset : %lf Gauss", field[7]);
		    mvprintw(12, 55, "Field X2: %lf Gauss", field[3]);
		    mvprintw(13, 55, "Field Y2: %lf Gauss", field[4]);
		    mvprintw(14, 55, "Field Z2: %lf Gauss", field[5]);
